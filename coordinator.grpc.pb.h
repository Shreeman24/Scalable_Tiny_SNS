...
class CoordService final {
 public:
  ...
  typedef WithAsyncMethod_Heartbeat<WithAsyncMethod_GetServer<WithAsyncMethod_GetAllFollowerServers<WithAsyncMethod_GetFollowerServer<Service > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_Heartbeat<WithCallbackMethod_GetServer<WithCallbackMethod_GetAllFollowerServers<WithCallbackMethod_GetFollowerServer<Service > > > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_Heartbeat<WithStreamedUnaryMethod_GetServer<WithStreamedUnaryMethod_GetAllFollowerServers<WithStreamedUnaryMethod_GetFollowerServer<Service > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_Heartbeat<WithStreamedUnaryMethod_GetServer<WithStreamedUnaryMethod_GetAllFollowerServers<WithStreamedUnaryMethod_GetFollowerServer<Service > > > > StreamedService;
};
...
class SynchService final {
 public:
  ...
  typedef WithAsyncMethod_GetAllUsers<WithAsyncMethod_GetTLFL<WithAsyncMethod_ResynchServer<Service > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_GetAllUsers<WithCallbackMethod_GetTLFL<WithCallbackMethod_ResynchServer<Service > > > CallbackService;
  typedef CallbackService ExperimentalCallbackService;
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_GetAllUsers<WithStreamedUnaryMethod_GetTLFL<WithStreamedUnaryMethod_ResynchServer<Service > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_GetAllUsers<WithStreamedUnaryMethod_GetTLFL<WithStreamedUnaryMethod_ResynchServer<Service > > > StreamedService;
};
